...
class Master(Process):
    ...
    def run(self):
        ...
        for i in range(self.iteration_limit):
            ...
            Ax_parts = self._collect_k_results(channel, i, 'ax')
            Ax_parts = self.code.decode(Ax_parts)
            ...
            grad_parts = self._collect_k_results(channel, i, 'grad')
            grad_parts = self.code.decode(grad_parts)
